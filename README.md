...
- 가설 4 : 20~30대의 높은 실업률이 결혼율 감소에  주요 원인일것이다.(추가데이터수집필요/2030실업률 데이터) / [이은석]
- 
>>>>>>> e27698a0dde22d44300c987770ae5c925cc4b19e

지방 공동화:

- ✅가설 1: 지방의 낮은 혼인율이 인구 감소를 가속화한다.

- ✅가설 2 : 지방의 자연증가율이 수도권보다 낮다. [최연우]

- 가설 3: 지방의 청년 인구 유출이 자연증가율 마이너스로 연결된다.(추가데이터수집필요/전국 인구수 및 인구이동 데이터)[이현희]

<<<<<<< HEAD
- ✅가설 4: 수도권으로의 인구 유입이 지방 인구 감소를 가속화한다.(추가데이터수집필요/전국 인구수 및 인구이동 데이터)[이현희]
=======
